...
// DP
// 在上一题的基础上加了有环这个条件，即第 1 个房子会影响第 i 个房子，所以需要特殊判断一下第 1 个房子的情况

// 状态表示：
// f[i] 表示在前 1 ~ i 个房子中，偷窃第 i 个房子的情况下，所偷窃的最大值
// g[i] 表示在前 1 ~ i 个房子中 不偷窃第 i 个房子的情况下，所偷窃的最大值

//【1】不偷第 1 个房子，则第 n 个房子可偷可不偷，答案为 max(f[n], g[n])
